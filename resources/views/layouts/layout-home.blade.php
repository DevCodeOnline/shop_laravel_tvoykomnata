        ...
        <div class="header-up">
            ...
            <div class="header-icons">
                <div class="header-icons__search">
                    <img class="button-search" src="{{ asset('assets/front/img/search.svg') }}" alt="Search">
    ...
    <div class="h-grid">
        <div class="header-down">
            <div class="header-marker">
                <img src="{{ asset('assets/front/img/marker.svg') }}" alt="Marker">
                <span>Донецк</span>
            </div>
            <div class="header-call">
                ...
                <div class="header-call__phone">
                    <a href="tel:+380713337711">
                        <img src="{{ asset('assets/front/img/phone.svg')}}" alt="Phone">
